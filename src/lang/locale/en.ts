...
export default {
    ...
    REVIEW_EASY_FILE_MENU: "Review: Unfruitful",
    REVIEW_GOOD_FILE_MENU: "Review: Skip",
    REVIEW_HARD_FILE_MENU: "Review: Fruitful",
    REVIEW_NOTE_EASY_CMD: "Review note as unfruitful",
    REVIEW_NOTE_GOOD_CMD: "Review note as skip",
    REVIEW_NOTE_HARD_CMD: "Review note as fruitful",
