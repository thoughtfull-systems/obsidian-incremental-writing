...
export default {
    ...
    // main.ts
    OPEN_NOTE_FOR_REVIEW: "Open a note for incremental writing",
    REVIEW_CARDS: "Review flashcards",
    REVIEW_EASY_FILE_MENU: "Incremental Writing: Unfruitful",
    REVIEW_GOOD_FILE_MENU: "Incremental Writing: Skip",
    REVIEW_HARD_FILE_MENU: "Incremental Writing: Fruitful",
    REVIEW_NOTE_EASY_CMD: "Unfruitful",
    REVIEW_NOTE_GOOD_CMD: "Skip",
    REVIEW_NOTE_HARD_CMD: "Fruitful",
